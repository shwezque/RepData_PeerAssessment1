...
```
![histogram total steps](instructions_fig/hist_TotalSteps.png)
...
```
![plot interval steps](instructions_fig/plot_IntervalSteps.png)
...
hist(dailySteps.nw, breaks=20, col="#FF6659",
     ...
     main="Total number of steps taken each day")
```
![hist total steps new](instructions_fig/hist_DailyStepsNew.png)
...
```
![panel plot activity pattern](instructions_fig/panelplot_WeekendWeekdayActivityPattern.png)
